    ...
    return `<article class="nl-report nl-visual-report">
      ...
      <section class="nl-chart-panel">
        ...
        ${m?`<div class="nl-technical-charts">
          <section class="nl-technical-block" aria-labelledby="nl-macd-heading"><h5 id="nl-macd-heading">涨跌速度 · MACD</h5><div id="nl-macd-chart">${technical('MACD')}</div><p class="nl-indicator-explanation"><strong>看涨跌的“劲头”有没有变。</strong>红线向上穿过蓝线，通常提示走势转强；反过来则可能转弱。柱子越长，两条线相差越大。它反应较慢，要和价格、成交量一起看。</p></section>
          <section class="nl-technical-block" aria-labelledby="nl-rsi-heading"><h5 id="nl-rsi-heading">涨跌强弱 · RSI</h5><div id="nl-rsi-chart">${technical('RSI')}</div><p class="nl-indicator-explanation"><strong>看近期上涨、下跌哪边更强。</strong>它用 0—100 的刻度比较近 14 个交易日的涨跌力度：越高，上涨越占优势；越低，下跌越占优势。高于 70 可能涨得偏热，低于 30 可能跌得偏多，但不代表马上会反转。</p></section>
        </div>`:''}
